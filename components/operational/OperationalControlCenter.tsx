...
interface OperationalControlCenterProps { dashboards: Dashboard[]; currentDashboard: Dashboard; globalThresholds: ComplianceThresholds; year: number; onNavigateToKpi?: (dashboardId: number | string, itemId: number | string) => void; }
...
export const OperationalControlCenter: React.FC<OperationalControlCenterProps> = ({ dashboards, currentDashboard, globalThresholds, year, onNavigateToKpi }) => {
  ...
  return <div className="space-y-8 animate-in fade-in duration-500">
    ...
    <ControlSection title="Requiere atención" subtitle="Señales priorizadas por criticidad, deterioro y atraso."><OperationalAlertsCenter dashboards={relevantDashboards} globalThresholds={globalThresholds} year={year} compact onNavigateToKpi={onNavigateToKpi} /></ControlSection>
