...
export const CurrentPeriodFocus: React.FC<CurrentPeriodFocusProps> = ({
    ...
    }, [monthlyProgress, monthlyGoals, weeklyProgress, weeklyGoals, isWeekly, year, currentYear, isPastYear, periodIdx, item]);
    ...
    return (
        <div className="relative bg-slate-900/60 backdrop-blur-3xl border border-cyan-500/30 rounded-3xl p-4 shadow-2xl animate-in zoom-in-95 duration-500">
            <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div className="flex-1">
                    ...
                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter italic leading-none">{indicator}</h2>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 mb-3">
                        <div className="lg:col-span-8 flex flex-col gap-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className={`bg-slate-950/40 border border-white/5 rounded-2xl p-3 transition-all shadow-inner ${canEdit && !item.isActivityMode ? 'focus-within:border-cyan-500/50' : 'opacity-80 grayscale-[0.5]'}`}>
                                ...
                                <div className={`bg-slate-950/40 border border-white/5 rounded-2xl p-3 transition-all shadow-inner ${canEdit && !item.isActivityMode ? 'focus-within:border-emerald-500/50' : 'opacity-80 grayscale-[0.5]'}`}>
                                    ...
                                    <input
                                        ...
                                        disabled={!canEdit || item.isActivityMode}
                                        className="w-full bg-transparent text-2xl font-black text-emerald-400 tabular-nums outline-none disabled:cursor-not-allowed"
                                        placeholder="0.00"
                                    />
                                </div>
                            </div>
                            ...
                            <div className={`bg-slate-950/40 border border-white/5 rounded-2xl p-3 shadow-inner ${!canEdit && 'opacity-80'}`}>
                            ...
                            {canEdit && (
                                <button
                                    ...
                                    disabled={isSaving}
                                    className={`w-full py-3 rounded-xl font-black uppercase tracking-[0.2em] text-[10px] transition-all shadow-xl ${isSaving ? 'bg-emerald-600 text-white' : 'bg-cyan-600 hover:bg-cyan-500 text-white shadow-cyan-900/20 hover:scale-[1.01]'}`}
                                >
                        ...
                        <div className="lg:col-span-4 flex flex-col">
                            <div className="bg-slate-950/60 border border-cyan-500/20 rounded-2xl p-4 flex flex-col justify-center shadow-xl h-full relative overflow-hidden">
                                ...
                                <div className="mt-4 pt-3 border-t border-white/5 flex justify-between items-center text-[9px] font-black uppercase tracking-widest">
